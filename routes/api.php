...
Route::middleware(['auth:api', 'prefixData'])->resource('cars', CarController::class)->only([
    'index', 'show', 'store', 'destroy'
]);

Route::middleware(['auth:api', 'prefixData'])->resource('trips', TripController::class)->only([
    'index', 'store'
]);
